...
use StendenINF1I\WaterUpApi\Exception\ConfigurationErrorException;
use StendenINF1I\WaterUpApi\Exception\FileNotFoundException;
use StendenINF1I\WaterUpApi\Exception\XMLParserException;
use StendenINF1I\WaterUpApi\Helper\ParameterContainer;
...
class ConfigLoader
{
     ...
     * @return ConfigLoader
     */
    public static function getLoader(): ConfigLoader
    {
